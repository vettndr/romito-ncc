...
<template>
  <div
    class="form-hero-contact hero-form-background rounded lg:col-span-5 lg:col-start-8 lg:px-8 lg:flex lg:flex-col lg:py-10"
  >
    ...
    <p
      v-if="submitted"
      class="mt-10 p-2 border border-heading text-center text-heading"
    >
